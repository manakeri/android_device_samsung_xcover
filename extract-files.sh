...
PRODUCT_COPY_FILES += \\
    ...
    vendor/samsung/__DEVICE__/proprietary/etc/gst.conf:system/etc/gst.conf \\
    vendor/samsung/__DEVICE__/proprietary/etc/etc/wifidirect_defaults.conf:system/etc/wifidirect_defaults.conf \\
